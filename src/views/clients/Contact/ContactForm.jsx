              ...
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 size-10 bg-red-100 rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+923071113330" className="text-red-600 hover:text-red-700 text-sm">
                        +92 307 111 333 0
                      </a>
                    </div>
                  </div>
                  ...
                  {/* WhatsApp */}
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 size-10 bg-green-100 rounded-lg flex items-center justify-center">
