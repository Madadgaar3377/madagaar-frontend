      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 section-padding-sm">
                ...
                <div className="p-3 sm:p-4 flex-1 flex flex-col">
                  ...
                  <div className="mt-3 sm:mt-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 sm:gap-3">
                    ...
                    <div className="flex items-center gap-2 w-full">
                      <Link
                        href={`/loans/${plan._id || plan.planId}`}
        ...
        <div className="rounded-2xl bg-white p-6 border shadow-soft flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex gap-3">
            <button type="button" onClick={() => router.push("/contact")} className="px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-red-200 min-h-touch">Contact Us</button>
            <button type="button" onClick={() => router.push("/loan/apply")} className="btn-primary px-4 py-2 rounded-lg">Start Application</button>
          </div>
        </div>
        </AnimatedSection>
