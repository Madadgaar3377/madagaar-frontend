    ...
    <div className="min-h-screen bg-gray-50 section-padding py-12">
      <div className="container-content max-w-3xl mx-auto">
        ...
        <div className="mt-6 flex gap-4">
          <Link href="/terms-and-conditions" className="text-[rgb(183,36,42)] font-semibold hover:underline">← Terms & Conditions</Link>
          <Link href="/account/register" className="text-[rgb(183,36,42)] font-semibold hover:underline">Sign up</Link>
        </div>
        </AnimatedSection>
      </div>
    </div>
