...
export default function HomePage() {
  ...
  const motionInitial = (mounted && reduceMotion) ? false : "hidden";
  const motionAnimate = (mounted && reduceMotion) ? false : "visible";
  ...
  const structuredData = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://madadgaar.com.pk/#localbusiness",
