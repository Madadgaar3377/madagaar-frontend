...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section
        ref={heroRef.ref}
        className={`w-full bg-gray-50 section-padding ${heroRef.isVisible ? 'animate-fade-in-up' : 'animate-on-scroll'}`}
      >
            ...
            <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 size-12 rounded-lg flex items-center justify-center text-white" style={{ backgroundColor: "rgb(183, 36, 42)" }}>
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 size-12 rounded-lg flex items-center justify-center bg-green-500">
