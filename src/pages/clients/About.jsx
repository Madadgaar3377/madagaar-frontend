   ...
   <section className="w-full min-h-screen flex flex-col md:flex-row items-center justify-between bg-gray-50 px-3 sm:px-6 md:px-12 lg:px-16 py-6 sm:py-8 md:py-12">
       <div className="md:w-1/2 mt-6 sm:mt-8 md:mt-0 flex justify-center w-full md:order-first">
        ...
        <div className="md:w-1/2 space-y-3 sm:space-y-4 lg:space-y-6 w-full">
          ...
          <button  style={{ backgroundColor: "rgb(183, 36, 42)" }} className="mt-4 sm:mt-6 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-white rounded-full font-medium hover:bg-blue-700 transition">
            Get Started
          </button>
        </div>
