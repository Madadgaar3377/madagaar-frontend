        ...
        <div className="bg-white border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <Link to="/about#team" className="hover:text-red-600 transition">Team</Link>
              <span>/</span>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              ...
              <div className="flex-shrink-0">
                <div className="relative">
                  <div className="w-48 h-48 sm:w-56 sm:h-56 lg:w-64 lg:h-64 rounded-full bg-white shadow-2xl overflow-hidden border-8 border-white/20">
                  ...
                  {/* Status Badge */}
                  <div className="absolute bottom-4 right-4 bg-green-500 w-6 h-6 rounded-full border-4 border-white shadow-lg"></div>
                </div>
              </div>
                    ...
                    <>
                      ...
                      <div className="border border-gray-200 rounded-xl overflow-hidden">
                        ...
                        >
                          <div className="flex items-center gap-3 sm:gap-4 flex-1">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center text-xl sm:text-2xl" style={{ backgroundColor: "rgba(183, 36, 42, 0.1)" }}>
                              🎯
                            </div>
                            <h3 className="font-semibold text-gray-900 text-sm sm:text-base lg:text-lg text-left">Strategic Leadership</h3>
                          </div>
                          <svg className={`w-5 h-5 sm:w-6 sm:h-6 transition-transform ${expandedRole === 0 ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: "rgb(183, 36, 42)" }}>
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                          </svg>
                        </button>
                      ...
                      <div className="border border-gray-200 rounded-xl overflow-hidden">
                        ...
                        >
                          ...
                          <svg className={`w-5 h-5 sm:w-6 sm:h-6 transition-transform ${expandedRole === 1 ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: "rgb(183, 36, 42)" }}>
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                          </svg>
                        </button>
                      ...
                      <div className="border border-gray-200 rounded-xl overflow-hidden">
                        ...
                        >
                          ...
                          <svg className={`w-5 h-5 sm:w-6 sm:h-6 transition-transform ${expandedRole === 2 ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: "rgb(183, 36, 42)" }}>
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                          </svg>
                        </button>
            ...
            <div className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  {member.email && (
                    <div className="flex items-start gap-2 sm:gap-3">
                      <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "rgba(183, 36, 42, 0.1)", color: "rgb(183, 36, 42)" }}>
                ...
                <div className="bg-white rounded-2xl shadow-sm border p-4 sm:p-6">
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3">
                    ...
                    {member.socialLinks.instagram && (
                      ...
                      >
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 flex items-center justify-center text-white">
                          <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5A4.25 4.25 0 0 0 7.75 20.5h8.5A4.25 4.25 0 0 0 20.5 16.25v-8.5A4.25 4.25 0 0 0 16.25 3.5h-8.5zm4.25 3.25a5.25 5.25 0 1 1 0 10.5a5.25 5.25 0 0 1 0-10.5zm0 1.5a3.75 3.75 0 1 0 0 7.5a3.75 3.75 0 0 0 0-7.5zm5.3.95a1.05 1.05 0 1 1-2.1 0a1.05 1.05 0 0 1 2.1 0z"/>
                          </svg>
                        </div>
                    ...
                    {member.socialLinks.facebook && (
                      <a
                        ...
                        className="flex-1 min-w-[80px] sm:min-w-[100px] flex flex-col items-center gap-1.5 sm:gap-2 p-2 sm:p-3 rounded-lg bg-blue-50 hover:bg-blue-100 transition"
                      >
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-blue-800 flex items-center justify-center text-white">
                          <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                          </svg>
                        </div>
                    ...
                    {member.socialLinks.github && (
                      ...
                      >
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gray-800 flex items-center justify-center text-white">
                          <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                          </svg>
                        </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-4 sm:p-6">
                ...
                <div className="space-y-2">
                  <Link to="/about" className="flex items-center gap-2 text-gray-700 hover:text-red-600 transition text-sm">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <span className="text-xs sm:text-sm">About Madadgaar</span>
                  </Link>
                  <Link to="/about#team" className="flex items-center gap-2 text-gray-700 hover:text-red-600 transition text-sm">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <span className="text-xs sm:text-sm">Meet the Team</span>
                  </Link>
                  <Link to="/" className="flex items-center gap-2 text-gray-700 hover:text-red-600 transition text-sm">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                    </svg>
              ...
              {teamMembers.filter(m => m.id !== member.id).map((otherMember) => (
                ...
                >
                  <div className={`h-24 sm:h-28 lg:h-32 bg-gradient-to-br ${otherMember.color} flex items-center justify-center`}>
                    <div className="w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 rounded-full bg-white flex items-center justify-center text-3xl sm:text-3xl lg:text-4xl">
                      {otherMember.icon}
                    </div>
                  </div>
