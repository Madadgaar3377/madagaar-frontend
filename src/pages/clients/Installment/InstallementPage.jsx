                  ...
                  <div className="p-3 sm:p-4 lg:p-5 flex flex-col gap-2 sm:gap-3">
                    ...
                    <div className="flex gap-2 mt-1 sm:mt-2">
                      <Link
                        ...
                        className="flex-1 px-2 sm:px-3 lg:px-4 py-2 sm:py-2.5 rounded-lg bg-gradient-to-r from-[rgb(183,36,42)] to-red-600 text-white text-xs sm:text-sm font-medium hover:shadow-lg transition text-center"
                      >
                        View
                      </Link>
                      <a href={`tel:${plan.user?.number || ""}`} className="px-2 sm:px-3 lg:px-4 py-2 sm:py-2.5 rounded-lg border-2 border-[rgb(183,36,42)] text-[rgb(183,36,42)] text-xs sm:text-sm font-medium hover:bg-[rgb(183,36,42)] hover:text-white transition flex items-center justify-center">
