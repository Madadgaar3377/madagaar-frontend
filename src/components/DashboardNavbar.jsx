...
const DashboardNavbar = () => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-30 safe-area-top">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              {user?.profilePic ? (
                ...
                <div className="size-10 rounded-full bg-gradient-to-br from-red-500 to-red-700 flex items-center justify-center text-white font-semibold">
          ...
          <div className="px-4 pt-2 pb-3 space-y-1">
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg mb-3">
              {user?.profilePic ? (
                ...
                <div className="size-12 rounded-full bg-gradient-to-br from-red-500 to-red-700 flex items-center justify-center text-white font-semibold text-lg">
                  {(user?.name || 'U').charAt(0).toUpperCase()}
                </div>
              )}
              <div>
